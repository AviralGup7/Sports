...
import { ProgressPathCard } from "@/components/progress-path-card";
    ...
    <div className="stack-xl">
      ...
      <MotionIn className="detail-grid" delay={0.08}>
        <article className="detail-card">
          ...
          <p>{data.match.stage?.label ?? "Standalone board"} | {formatDateTime(data.match.day, data.match.startTime)}</p>
        </article>
        <article className="detail-card">
